...
def main():
    ...
    group.add_argument("--index", action="store_true", help="Show the games menu")
    group.add_argument("--snake", action="store_true", help="Play Snake")
    group.add_argument("--pong", action="store_true", help="Play Pong")
    group.add_argument("--tetris", action="store_true", help="Play Tetris")
